...
Detailed specs and architecture docs are in `devs/`:
- `devs/SPEC.md` - Complete specification (Chinese)
- `devs/ARCHITECTURE.md` - Technical architecture
- `devs/ROADMAP.md` - Development phases
